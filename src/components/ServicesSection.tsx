...
const ServiceCard = ({ title, description, icon, delay }: ServiceCardProps) => {
  ...
  return (
    <div 
      ref={cardRef}
      className="glass-card card-hover opacity-0 translate-y-10 transition-all duration-700 h-full max-w-[330px] mx-auto"
...
const ServicesSection = () => {
  ...
  return (
    <section 
      id="services" 
      ref={sectionRef}
      className="py-20 md:py-32 bg-gradient-to-b from-glow-dark to-glow-darkest relative opacity-0 transition-opacity duration-1000"
    >
