...
const HeroSection = () => {
  ...
  return (
    <section 
      id="hero" 
      ref={heroRef} 
      className="min-h-screen flex flex-col relative overflow-hidden transition-all duration-1000 opacity-0 translate-y-10"
      style={{
    ...
    >
      ...
      <div className="absolute inset-0 opacity-30 pointer-events-none z-0">
        <img 
          src="/lovable-uploads/e2026ebe-6097-4e46-a098-90af4da97dc1.png"
          alt="" 
      ...
      <div className="relative z-10 flex justify-between items-center p-6 md:p-10 w-full">
        ...
        <div className="cta">
          <GlowButton 
            ...
            size="lg" 
            className="font-semibold bg-green-600 hover:bg-green-700 text-white rounded-full px-8 py-3"
          >
            Get Free Proposal
          </GlowButton>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center relative z-10 px-6 md:px-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <h2 className="text-2xl md:text-3xl lg:text-4xl font-prata mb-8 text-cream">
            Where Web3 Brands Build Their Ark to Leave a Legacy
          </h2>
          
          <p className="text-xl md:text-2xl font-light mb-12 text-cream/90 max-w-3xl mx-auto">
            For content that commands attention, sets authority and builds loyalty that lasts.
          </p>
          
          <GlowButton 
            onClick={scrollToContact} 
            size="lg" 
            className="font-semibold bg-green-600 hover:bg-green-700 text-white rounded-full px-10 py-4"
          >
            Get Free Proposal
          </GlowButton>
        </div>
