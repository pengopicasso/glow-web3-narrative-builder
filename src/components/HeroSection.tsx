...
const HeroSection = () => {
  ...
  return <section id="hero" ref={heroRef} className="min-h-screen relative flex items-center justify-center pt-20 overflow-hidden transition-all duration-1000 opacity-0 translate-y-10">
      ...
      <div className="container mx-auto px-4 relative z-10 py-20 md:py-32">
        <div className="flex flex-col items-center bg-[#aed7ae]">
          <img src="/lovable-uploads/dcdbb9e3-92d3-451a-b81d-4a5ca421d8fd.png" alt="NOA Media Logo" className="h-32 md:h-48 w-auto mb-10 animate-float" />
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-white/80 mb-10 animate-slide-up" style={{
            animationDelay: '0.2s'
          }}>
